...
export const versions: Download[] = [
  ...
  },
  {
    ...
    variants: {
      fl: '/files/v1.1.0/§r§lFurfSky §6§lReborn §8§lFL §8§l[§71.1.0§8§l].zip',
      ov: '/files/v1.1.0/§r§lFurfSky §6§lReborn §8§lOV §8§l[§71.1.0§8§l].zip',
    },
  },
  {
    version: 'v1.0.0',
    name: 'FULL RELEASE',
    variants: {
      fl: '/files/v1.0.0/§r§lFurfSky §c§lR§6§le§e§lb§a§lo§9§lr§d§ln §8§lFL §8§l[§71.0.0§8§l].zip',
      ov: '/files/v1.0.0/§r§lFurfSky §c§lR§6§le§e§lb§a§lo§9§lr§d§ln §8§lOV §8§l[§71.0.0§8§l].zip',
    },
  },
  {
    version: 'v0.2.0',
    ...
    variants: {
      fl: '/files/v0.2.0/§6Furf§5Sky §eReborn §8§lFL [§70.2.0.§8§l].zip',
      ov: '/files/v0.2.0/§6Furf§5Sky §eReborn §8§lOV [§70.2.0.§8§l].zip',
    },
  },
];
